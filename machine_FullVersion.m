...
Capstone_start = 0.00;
Capstone_end = 0.40; %0.4
Capstone_numpoint = 41; %3
...
% Analyte define
Analyte = 'MilliQ'; % MilliQ, Volvic, Evian, Gerolsteiner, Adelholzener, Spree, Brandenburger Quell, Vio, Aqua mia, NaCl, Na2SO4, Na2CO3
            ...
            for Analyte_frac = linspace(Analyte_start, Analyte_end, Analyte_numpoint) % depend on how many analyte concs want to test
                ...
                for Capstone_frac = linspace(Capstone_start, Capstone_end, Capstone_numpoint) % a for loop to get different Capstone fraction calibration curves                   
                    ...
                    for HCsurf_frac = linspace(HCsurf_start, HCsurf_end, HCsurf_numpoint) %linspace(0.1,0.26,9) % a for loop for changing HCsurf fraction, and get a calibration curve
                        ...
                        % Make droplets starting from closed morphology
                        if HCsurf_frac == 0.00;
                            pause(60*5)
                        else
                            pause(0) % continue;
                        ...
                        for i = 1:Fig_num
                            ...
                            fname = 'Q:\CC-Droplab\sideview\2024\Katrina\Sensing(KS)\KS_108\KS_108.3';
                            ...
                            filename = [num2str(Capstone_frac,'%4.2f'),'Capstone-',num2str(HCsurf_frac),surfactant,'-',num2str(Analyte_frac),Analyte,'-',num2str(repeat),'run-Calibration-',num2str(i),'.png']; %can be 'png','jpg','tif'
