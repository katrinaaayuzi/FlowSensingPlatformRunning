...
HCsurf_start = 0.05;% for CA about 60 degrees, SDS = 0.14, SDBS = 0.05
HCsurf_end = 0.05;
HCsurf_numpoint = 1;
...
% Analyte define
Analyte = 'MilliQ'; % MilliQ, Volvic, Evian, Gerolsteiner, Adelholzener, Spree, Brandenburger Quell, Vio, NaCl, Na2SO4, Na2CO3
                    ...
                    for HCsurf_frac = linspace(HCsurf_start, HCsurf_end, HCsurf_numpoint) %linspace(0.1,0.26,9) % a for loop for changing HCsurf fraction, and get a calibration curve
                        ...
                        parfor j = 1:Flowrate_check_num
                            ...
                            if sensorValue_Flow_3 < -0.5 % or smaller than 0, but to except some random error so -0.5
                                ...
                                fgt_set_sensorRegulation(3, 3, 0.0);
                        ...
                        for i = 1:Fig_num
                            ...
                            fname = 'Q:\CC-Droplab\sideview\2024\Katrina\Sensing(KS)\KS_101\KS_101.1';
